...
struct PF1550Test {
  static void test_DeviceId_address() {
    ...
    TEST_ASSERT_EQUAL(0x0, pf1550.GetRegister<DeviceId>().kRegisterAddress);
  }
  static void test_OtpFlavor_address() {
    PF1550<OtpFlavor> pf1550(0x08);
    TEST_ASSERT_EQUAL(0x1, pf1550.GetRegister<OtpFlavor>().kRegisterAddress);
  }

  static void test_SiliconRev_address() {
    PF1550<SiliconRev> pf1550(0x08);
    TEST_ASSERT_EQUAL(0x2, pf1550.GetRegister<SiliconRev>().kRegisterAddress);
  }

  static void test_IntCategory_address() {
    PF1550<IntCategory> pf1550(0x08);
    TEST_ASSERT_EQUAL(0x6, pf1550.GetRegister<IntCategory>().kRegisterAddress);
  }

  static void test_SwIntStat0_address() {
    PF1550<SwIntStat0> pf1550(0x08);
    TEST_ASSERT_EQUAL(0x8, pf1550.GetRegister<SwIntStat0>().kRegisterAddress);
  }

  static void test_SwIntMask0_address() {
    PF1550<SwIntMask0> pf1550(0x08);
    TEST_ASSERT_EQUAL(0x9, pf1550.GetRegister<SwIntMask0>().kRegisterAddress);
  }

  static void test_SwIntSense0_address() {
    PF1550<SwIntSense0> pf1550(0x08);
    TEST_ASSERT_EQUAL(0xa, pf1550.GetRegister<SwIntSense0>().kRegisterAddress);
  }

  static void test_SwIntStat1_address() {
    PF1550<SwIntStat1> pf1550(0x08);
    TEST_ASSERT_EQUAL(0xb, pf1550.GetRegister<SwIntStat1>().kRegisterAddress);
  }

  static void test_SwIntMask1_address() {
    PF1550<SwIntMask1> pf1550(0x08);
    TEST_ASSERT_EQUAL(0xc, pf1550.GetRegister<SwIntMask1>().kRegisterAddress);
  }

  static void test_SwIntSense1_address() {
    PF1550<SwIntSense1> pf1550(0x08);
    TEST_ASSERT_EQUAL(0xd, pf1550.GetRegister<SwIntSense1>().kRegisterAddress);
  }

  static void test_SwIntStat2_address() {
    PF1550<SwIntStat2> pf1550(0x08);
    TEST_ASSERT_EQUAL(0xe, pf1550.GetRegister<SwIntStat2>().kRegisterAddress);
  }

  static void test_SwIntMask2_address() {
    PF1550<SwIntMask2> pf1550(0x08);
    TEST_ASSERT_EQUAL(0xf, pf1550.GetRegister<SwIntMask2>().kRegisterAddress);
  }
  ...
  static void test_ReadRegister() {
    ...
    pf1550.Initialize();
    pf1550.GetRegister<DeviceId>().ReadRegister();
    ...
    Verify(OverloadedMethod(ArduinoFake(Wire), write, size_t(uint8_t))
               .Using(pf1550.GetRegister<DeviceId>().kRegisterAddress))
        .Exactly(1);
  ...
  static void test_WriteRegister() {
    ...
    pf1550.Initialize();
    pf1550.GetRegister<Pwrctrl3>().WriteRegister(data);
    ...
    Verify(OverloadedMethod(ArduinoFake(Wire), beginTransmission, void(uint8_t))
        ...
        .Exactly(1);
    Verify(OverloadedMethod(ArduinoFake(Wire), write, size_t(uint8_t))
               .Using(pf1550.GetRegister<Pwrctrl3>().kRegisterAddress))
        .Exactly(1);
    Verify(
